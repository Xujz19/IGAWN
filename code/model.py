...
class IGAWN(nn.Module):
    def __init__(self, n_colors=3, n_feats=32, bias=False):
        ...
        # IlluminationNet
        self.netI_conv_head = nn.Conv2d(4, n_feats//2, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, x):
        ...
        map0 = self.netI_conv_head(torch.cat([1-Gray, x], dim=1))
...
if __name__=='__main__':
    ...
    with torch.no_grad():
        ...
        macs, params = get_model_complexity_info(model, (3, 600, 400), as_strings=True,
